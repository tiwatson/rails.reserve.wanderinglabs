module InitialImport::ReserveAmerica
  class BookingWindow
    ...
    def url
      ...
      "https://www.reserveamerica.com/camping/x/r/campsiteDetails.do?siteId=#{site_id}&contractCode=#{facility.details['contract_code']}&parkId=#{facility.park_id}&offset=0&arvdate=1/1/2020&lengthOfStay=1"
    end
